...
const whyItems = [
  ...
  },
  {
    ...
    body: 'Chapa-powered checkout with secure payment processing. Your payment data is handled directly by Chapa.',
    accent: '#34d399',
        ...
        >
          ...
          <div style={{ position: 'relative' }}>
            ...
            <p style={{ color: '#8aaa68', fontSize: 15, lineHeight: 1.7, margin: '0 0 32px', maxWidth: 460 }}>
              Create your event, set up ticket types, publish, and start selling. Chapa payments, QR check-in, and real-time analytics included.
            </p>
