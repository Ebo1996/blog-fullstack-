        ...
        >
          <div>
            ...
            <p style={{ color: 'var(--muted-foreground)', fontSize: 14, lineHeight: 1.65, margin: '0 0 28px' }}>
              Create an event, set up ticket types, publish, and start selling in minutes. Chapa handles payments — you handle the event.
            </p>
            <Link
              href="/organizer"
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            {[
              ...
              { icon: <Shield size={16} />, text: 'Chapa payments — secure Ethiopian gateway' },
            ].map((item) => (
              <div
                key={item.text}
